...
class QuestionService:
    ...
    def list_questions(search: str = None):
        return QuestionRepository.list_questions(search)

    @staticmethod
    def list_questions_for_user(user_id):
        return QuestionRepository.list_questions_for_user(int(user_id))
    ...
    def create_question(user, question_text: str, choices: list[str] = None):
        return QuestionRepository.create_question(user.id, question_text, choices)
